...
if __name__ == '__main__':
    ...
    A_eff = 67.9 * 10**(-12)  # acoustic-optic effective area, unit: m ** 2
    ...
    omega_diffpprobeSpan = 2 * pi * np.linspace(-20, 20, 200) * 10**6
    ...
    for omega_diffpprobe, i in zip(omega_diffpprobeSpan, np.arange(len(omega_diffpprobeSpan))):
        ...
        delta_k0 = delta_k(1.45, 1.45, omega1, omega3)
    ...
    plt.plot((omega_diffpprobeSpan) / (2 * pi * 10**6), rfwm_span)
